...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  match = spicy_foods.filter {|food| food[:cuisine] == cuisine}
  match[0]
end
...
def print_spiciest_foods(spicy_foods)
  # your code here
  very_spicy = spicy_foods.filter {|food| food[:heat_level] > 5}
  very_spicy.each do |food|
    heat = food[:heat_level].to_i
    puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * heat}"
  end
end
